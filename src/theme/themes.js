...
const THEMES = {
  dark: {
    ...
    warn:"#F59E0B", override:"#B45309",
    cell_inc:"#9CB336", cell_inc_bg:"#0F1A00", cell_inc_bd:"#4A6600", cell_exp:"#FFD24D", over:"#FF7EB6",
    tab_exp:"#6B1A10", tab_inc:"#2A4A00", tab_pend:"#5A3A00",
  ...
  firetv: {
    ...
    cell_inc:"#509749", cell_inc_bg:"#0D1F0C", cell_inc_bd:"#2A5A28", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Konsolengrün — Fast-Schwarz mit sattem Signalgrün ───────────────────
  xbox: {
    ...
    cell_inc:"#499D49", cell_inc_bg:"#061406", cell_inc_bd:"#1A4A1A", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Konsolenblau — dunkles Marineblau mit hellem Cyan-Akzent ────────────
  ps5: {
    ...
    cell_inc:"#009F6A", cell_inc_bg:"#00180E", cell_inc_bd:"#005A38", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Märchenblau — Mitternachtsblau mit kräftigem Königsblau ─────────────
  disneyplus: {
    ...
    cell_inc:"#149C7D", cell_inc_bg:"#001A14", cell_inc_bd:"#006050", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Serienrot — Kohleschwarz mit leuchtendem Rot ────────────────────────
  netflix: {
    ...
    cell_inc:"#37A552", cell_inc_bg:"#091A0E", cell_inc_bd:"#1A5A28", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Funkmagenta — fast schwarzes Aubergine mit Magenta-Akzent ───────────
  magenta: {
    ...
    cell_inc:"#4BA264", cell_inc_bg:"#081A10", cell_inc_bd:"#205A30", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  // ── Handyhell — helles Systemgrau mit klarem Systemblau ─────────────────
  ios: {
  ...
  // ── Suchblau — weiße Karten auf Fast-Weiß, ruhiges Blau ─────────────────
  material: {
  ...
  // ── Direktbank — entsättigtes Hellblau, weiße Karten, tiefes Blau ───────
  dkb: {
  ...
  obsidian: {
    ...
    // Einnahmen: Smaragd
    pos:"#00D68F",
    cell_inc:"#00A770",  cell_inc_bg:"#00200F", cell_inc_bd:"#005030", cell_exp:"#FFD24D", over:"#FF7EB6",
    // Ausgaben: Hellorange
    neg:"#00D9FF",
    // Gold/Warn: Bernstein
    gold:"#FFB547",
    ...
    cond_neg:"#00D9FF", neg_aktuell:"#59E6FF", neg_vm:"#8CEEFF", warn_bold:"#FF8800", warn_icon:"#FFD24D",  cond_warn:"#FFB547",  cond_gold:"#FFD166",  cond_pos:"#BFFF00", pos_aktuell:"#D5FF59", pos_vm:"#E2FF8C",
  },
  ...
  terminal: {
    ...
    cond_neg:"#00D9FF", neg_aktuell:"#59E6FF", neg_vm:"#8CEEFF", warn_bold:"#FF8800", warn_icon:"#FFD24D",  cond_warn:"#FFD700",  cond_gold:"#FFD700",  cond_pos:"#BFFF00", pos_aktuell:"#D5FF59", pos_vm:"#E2FF8C",
  },
  ...
  // (Nutzer-Foto). Entscheidend sind dort VIER Dinge:
...
THEMES.hellgrau = {
  ...
  err:"#CC2B1D", cond_neg:"#0097A7", cond_pos:"#4D6E00",
...
THEMES.kontrastdunkel = {
  ...
  blue:"#5AB7FF", pos:"#3FD06A", neg:"#00D9FF", gold:"#FFC83D",
  ...
  cond_neg:"#00D9FF", neg_aktuell:"#59E6FF", neg_vm:"#8CEEFF", warn_bold:"#FF8800", warn_icon:"#FFD24D", cond_warn:"#FFA53D", cond_gold:"#FFD23D", cond_pos:"#BFFF00", pos_aktuell:"#D5FF59", pos_vm:"#E2FF8C",
...
THEMES.mitternacht = {
  ...
  blue:"#6CB4FF", pos:"#4FD08A", neg:"#00D9FF", gold:"#FFC861",
  on_accent:"#08101F", mid:"#67E8F9",
  cell_inc:"#4AAF7D", cell_inc_bg:"#08200F", cell_inc_bd:"#1E5A3A", cell_exp:"#FFD24D", over:"#FF7EB6",
  ...
  cond_neg:"#00D9FF", neg_aktuell:"#59E6FF", neg_vm:"#8CEEFF", warn_bold:"#FF8800", warn_icon:"#FFD24D", cond_warn:"#FFA552", cond_gold:"#FFD263", cond_pos:"#BFFF00", pos_aktuell:"#D5FF59", pos_vm:"#E2FF8C",
...
THEMES.modernslate = {
  ...
  blue:"#5B9DF9", pos:"#A3E635", neg:"#00D9FF", gold:"#FBBF24",
  on_accent:"#0C1206", disabled:"#2A2F3A", warn:"#FBBF24", override:"#B5830F",
  mid:"#67E8F9",
  cell_inc:"#7FB329", cell_inc_bg:"#18200A", cell_inc_bd:"#4A6612", cell_exp:"#FFD24D", over:"#FF7EB6",
  tab_exp:"#3A1414", tab_inc:"#1E2A0A", tab_pend:"#332A0A",
  err:"#FF4D4D", err_bg:"#350F0F",
  vorm_bg:"#332A0A", vorm_bd:"#FFD700",
  ...
  cond_neg:"#00D9FF", neg_aktuell:"#59E6FF", neg_vm:"#8CEEFF", warn_bold:"#FF8800", warn_icon:"#FFD24D", cond_warn:"#FBBF24", cond_gold:"#FCD34D", cond_pos:"#BFFF00", pos_aktuell:"#D5FF59", pos_vm:"#E2FF8C",
  name:"Modern Slate",
};
...
THEMES.deepocean = {
  ...
  mid:"#67E8F9",
  cell_inc:"#95C700", cell_inc_bg:"#141F00", cell_inc_bd:"#4A6600", cell_exp:"#FFD24D", over:"#FF7EB6",
  tab_exp:"#3A1010", tab_inc:"#1C2A00", tab_pend:"#332600",
  err:"#FF5252", err_bg:"#350E0E",
  vorm_bg:"#332600", vorm_bd:"#FFD700",
...
THEMES.weltraumtaschengeld = {
  ...
  blue:"#2EE6D6", pos:"#2EE6D6", neg:"#00D9FF", gold:"#FFD166",
  on_accent:"#04201C", disabled:"#232B55", warn:"#FFB84A", override:"#C77A2E",
  mid:"#8A7CFF",
  cell_inc:"#24B3A7", cell_inc_bg:"#062420", cell_inc_bd:"#1A6E63", cell_exp:"#FFD24D", over:"#FF7EB6",
...
THEMES.tastenhell = {
  ...
  // Amber der manuellen Ueberschreibung. Beide Toene mussten nachgerechnet
  // werden: der geerbte #B45309 schafft auf der Platte nur 4,23:1 (der Test
  // hat es aufgedeckt, geschaetzt war er auf 4,6) und auf der Taste gar nur
  // 1,56:1. #AB4E08 traegt auf der Platte, #FFC46B auf der Taste — beide
  // bleiben erkennbar Amber.
  acc_override:"#AB4E08",     acc_override_card:"#FFC46B", // Platte 4,62:1 · Taste 4,97:1
  ...
  flaechen_extra:{
    // Der Hero ist wieder DECKEND. Ein Versuch mit Glas (14 % Durchsicht plus
    // Rueckseiten-Unschaerfe) sollte die harte Kante aufloesen, an der die
    // Liste unter ihm verschwindet — er brachte aber nichts, weil hinter dem
    // Hero gar nicht die Liste liegt, sondern der sticky-Block der
    // Monatsansicht, und der ist mit der Hintergrundfarbe DECKEND gemalt
    // (MonatScreen.jsx). Die Kante loest jetzt ein weicher Auslauf unter dem
    // Hero auf — dort, wo der Inhalt tatsaechlich verschwindet.
...
function getTheme(name) {
  ...
  // neg_aktuell: feste "aktuell/noch nicht abgeschlossen"-Variante für
  // Ausgaben-Buchungen (statt einer berechneten Abdunklung) — nur die 16
  // dunklen Themes definieren sie fest; alle anderen fallen auf neg zurück.
  if (!t.neg_aktuell) t.neg_aktuell = t.neg;
  // neg_vm: noch blasser als neg_aktuell — für Vormerkungen (Ausgabe-Seite),
  // die im Gegensatz zu "aktuellen" Buchungen nie "abgeschlossen" werden.
  if (!t.neg_vm) t.neg_vm = t.neg_aktuell;
  if (!t.cond_warn) t.cond_warn = "#E67E22";
  if (!t.cond_gold) t.cond_gold = "#F1C40F";
  if (!t.cond_pos)  t.cond_pos  = "#2ECC71";
  // pos_aktuell: Pendant zu neg_aktuell für Einnahmen-Buchungen.
  ...
  // warn_icon: Warnfarbe für Symbole/Icons und Warntext (Amber) — getrennt von
  // warn_bold, das für vollflächige Warn-Hintergründe (Banner) reserviert ist.
  if (!t.warn_icon) t.warn_icon = t.gold;
