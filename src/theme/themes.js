...
const THEMES = {
  dark: {
    ...
    blue:"#AACC00", pos:"#AACC00", neg:"#FFB347", gold:"#F5A623",
    ...
    cell_inc:"#9CB336", cell_inc_bg:"#0F1A00", cell_inc_bd:"#4A6600", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#E67E22", cond_gold:"#F1C40F", cond_pos:"#2ECC71",
  ...
  firetv: {
    ...
    blue:"#FF9900", pos:"#67C15E", neg:"#FFB347", gold:"#FF9900",
    ...
    cell_inc:"#509749", cell_inc_bg:"#0D1F0C", cell_inc_bd:"#2A5A28", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#FF9900", cond_gold:"#FFD700", cond_pos:"#67C15E",
    name:"Amazon Fire TV",
  },
  // ── Xbox Series S/X ──────────────────────────────────────────────────────
  xbox: {
    ...
    blue:"#107C10", pos:"#5EC95E", neg:"#FFB347", gold:"#FFB900",
    ...
    cell_inc:"#499D49", cell_inc_bg:"#061406", cell_inc_bd:"#1A4A1A", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#FFB900", cond_gold:"#FFD700", cond_pos:"#5EC95E",
    name:"Xbox Series",
  },
  // ── PlayStation 5 ────────────────────────────────────────────────────────
  ps5: {
    ...
    blue:"#00A0D6", pos:"#00CC88", neg:"#FFB347", gold:"#F0C040",
    ...
    cell_inc:"#009F6A", cell_inc_bg:"#00180E", cell_inc_bd:"#005A38", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#F0C040", cond_gold:"#FFD700", cond_pos:"#00CC88",
    name:"PlayStation 5",
  },
  // ── Disney+ ──────────────────────────────────────────────────────────────
  disneyplus: {
    ...
    blue:"#1464D6", pos:"#1AC8A0", neg:"#FFB347", gold:"#F5C518",
    ...
    cell_inc:"#149C7D", cell_inc_bg:"#001A14", cell_inc_bd:"#006050", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#F5C518", cond_gold:"#FFD700", cond_pos:"#1AC8A0",
    name:"Disney+",
  },
  // ── Netflix ──────────────────────────────────────────────────────────────
  netflix: {
    ...
    blue:"#E50914", pos:"#46D369", neg:"#FFB347", gold:"#F5A623",
    ...
    cell_inc:"#37A552", cell_inc_bg:"#091A0E", cell_inc_bd:"#1A5A28", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#F5A623", cond_gold:"#FFD700", cond_pos:"#46D369",
    name:"Netflix",
  },
  // ── MagentaTV ────────────────────────────────────────────────────────────
  magenta: {
    ...
    blue:"#E20074", pos:"#60D080", neg:"#FFB347", gold:"#FFB800",
    ...
    cell_inc:"#4BA264", cell_inc_bg:"#081A10", cell_inc_bd:"#205A30", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347", cond_warn:"#FFB800", cond_gold:"#FFD700", cond_pos:"#60D080",
    name:"MagentaTV",
  },
  // ── iOS / Apple Light ────────────────────────────────────────────────────
  ios: {
  ...
  obsidian: {
    ...
    // Einnahmen: Smaragd
    pos:"#00D68F",
    cell_inc:"#00A770",  cell_inc_bg:"#00200F", cell_inc_bd:"#005030", cell_exp:"#FFDD59", over:"#FF7EB6",
    // Ausgaben: Hellorange
    neg:"#FFB347",
    // Gold/Warn: Bernstein
    gold:"#FFB547",
    ...
    cond_neg:"#FFB347",  cond_warn:"#FFB547",  cond_gold:"#FFD166",  cond_pos:"#00D68F",
  },
  ...
  terminal: {
    ...
    cell_inc:"#00C733",  cell_inc_bg:"#001A00", cell_inc_bd:"#005500", cell_exp:"#FFDD59", over:"#FF7EB6",
    ...
    cond_neg:"#FFB347",  cond_warn:"#FFD700",  cond_gold:"#FFD700",  cond_pos:"#00FF41",
  },
...
THEMES.darkhell = {
  ...
  neg:"#FFB347",                       // Hellorange — bessere Lesbarkeit auf Grau
  err:"#FFA090", cond_neg:"#FFB347",
  disabled:"#3A4046",
...
THEMES.kontrastdunkel = {
  ...
  blue:"#5AB7FF", pos:"#3FD06A", neg:"#FFB347", gold:"#FFC83D",
  on_accent:"#05140A", disabled:"#2A2A2A", warn:"#FFB02E", override:"#C2740A",
  mid:"#67E8F9",
  cell_inc:"#4AAF6C", cell_inc_bg:"#06160C", cell_inc_bd:"#1E5A33", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#FFA53D", cond_gold:"#FFD23D", cond_pos:"#3FD06A",
...
THEMES.mitternacht = {
  ...
  blue:"#6CB4FF", pos:"#4FD08A", neg:"#FFB347", gold:"#FFC861",
  on_accent:"#08101F", mid:"#67E8F9",
  cell_inc:"#4AAF7D", cell_inc_bg:"#08200F", cell_inc_bd:"#1E5A3A", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#FFA552", cond_gold:"#FFD263", cond_pos:"#4FD08A",
...
THEMES.modernslate = {
  ...
  blue:"#5B9DF9", pos:"#A3E635", neg:"#FFB347", gold:"#FBBF24",
  on_accent:"#0C1206", disabled:"#2A2F3A", warn:"#FBBF24", override:"#B5830F",
  mid:"#67E8F9",
  cell_inc:"#7FB329", cell_inc_bg:"#18200A", cell_inc_bd:"#4A6612", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#FBBF24", cond_gold:"#FCD34D", cond_pos:"#A3E635",
  name:"Modern Slate",
};
...
THEMES.deepocean = {
  ...
  // (#FFB347) statt Rot — deutlich bessere Lesbarkeit im Dark Theme, klar
  // unterscheidbar vom separaten err-Ton.
  blue:"#65E3FD", pos:"#BFFF00", neg:"#FFB347", gold:"#FFC861",
  on_accent:"#06121A", disabled:"#3A414A", warn:"#FFB54A", override:"#C2820F",
  mid:"#67E8F9",
  cell_inc:"#95C700", cell_inc_bg:"#141F00", cell_inc_bd:"#4A6600", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#FFB54A", cond_gold:"#FFD263", cond_pos:"#BFFF00",
  name:"Deep Ocean",
};
...
THEMES.weltraumtaschengeld = {
  ...
  blue:"#2EE6D6", pos:"#2EE6D6", neg:"#FFB347", gold:"#FFD166",
  on_accent:"#04201C", disabled:"#232B55", warn:"#FFB84A", override:"#C77A2E",
  mid:"#8A7CFF",
  cell_inc:"#24B3A7", cell_inc_bg:"#062420", cell_inc_bd:"#1A6E63", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#FFB84A", cond_gold:"#FFD166", cond_pos:"#2EE6D6",
...
THEMES.magazin = {
  ...
  pos:"#A3C585", neg:"#FFB347", gold:"#D9B45B",
  on_accent:"#241304", disabled:"#2A2D34",
  warn:"#D9964A", override:"#A96A2A",
  mid:"#8FB6C9",
  cell_inc:"#7F9A68", cell_inc_bg:"#141B10", cell_inc_bd:"#3E5A2C", cell_exp:"#FFDD59", over:"#FF7EB6",
  ...
  cond_neg:"#FFB347", cond_warn:"#D9964A", cond_gold:"#D9B45B", cond_pos:"#A3C585",
...
function getTheme(name) {
  ...
  // (#FFDD59 Amber-Gelb); alle anderen fallen auf "gold" zurück (bisheriges
