...
const THEMES = {
  dark: {
    ...
    blue:"#AACC00", pos:"#AACC00", neg:"#FF1493", gold:"#F5A623",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#E67E22", cond_gold:"#F1C40F", cond_pos:"#2ECC71",
  ...
  light: {
    ...
    neg:"#C2185B",   // Etwas gedämpftes Rot
    ...
    cond_neg:"#C2185B", cond_warn:"#E67E22", cond_gold:"#D4A017", cond_pos:"#1A8A4A",
  ...
  firetv: {
    ...
    blue:"#FF9900", pos:"#67C15E", neg:"#FF1493", gold:"#FF9900",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FF9900", cond_gold:"#FFD700", cond_pos:"#67C15E",
    name:"Amazon Fire TV",
  },
  // ── Xbox Series S/X ──────────────────────────────────────────────────────
  xbox: {
    ...
    blue:"#107C10", pos:"#5EC95E", neg:"#FF1493", gold:"#FFB900",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFB900", cond_gold:"#FFD700", cond_pos:"#5EC95E",
    name:"Xbox Series",
  },
  // ── PlayStation 5 ────────────────────────────────────────────────────────
  ps5: {
    ...
    blue:"#00A0D6", pos:"#00CC88", neg:"#FF1493", gold:"#F0C040",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#F0C040", cond_gold:"#FFD700", cond_pos:"#00CC88",
    name:"PlayStation 5",
  },
  // ── Disney+ ──────────────────────────────────────────────────────────────
  disneyplus: {
    ...
    blue:"#1464D6", pos:"#1AC8A0", neg:"#FF1493", gold:"#F5C518",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#F5C518", cond_gold:"#FFD700", cond_pos:"#1AC8A0",
    name:"Disney+",
  },
  // ── Netflix ──────────────────────────────────────────────────────────────
  netflix: {
    ...
    blue:"#E50914", pos:"#46D369", neg:"#FF1493", gold:"#F5A623",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#F5A623", cond_gold:"#FFD700", cond_pos:"#46D369",
    name:"Netflix",
  },
  // ── MagentaTV ────────────────────────────────────────────────────────────
  magenta: {
    ...
    blue:"#E20074", pos:"#60D080", neg:"#FF1493", gold:"#FFB800",
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFB800", cond_gold:"#FFD700", cond_pos:"#60D080",
    name:"MagentaTV",
  },
  // ── iOS / Apple Light ────────────────────────────────────────────────────
  ios: {
  ...
  dkb: {
    ...
    cond_neg:"#C2185B", cond_warn:"#8A6800", cond_gold:"#A07800", cond_pos:"#1A5C2A",
    name:"DKB Hell",
  },
  ...
  obsidian: {
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493",  cond_warn:"#FFB547",  cond_gold:"#FFD166",  cond_pos:"#00D68F",
  },
  ...
  terminal: {
    ...
    cond_neg:"#FF1493", neg_aktuell:"#FF1493",  cond_warn:"#FFD700",  cond_gold:"#FFD700",  cond_pos:"#00FF41",
  },
...
THEMES.darkhell = {
  ...
  neg:"#FF1493",                       // Hellorange — bessere Lesbarkeit auf Grau
  err:"#FFA090", cond_neg:"#FF1493", neg_aktuell:"#FF1493",
  disabled:"#3A4046",
...
THEMES.hellgrau = {
  ...
  err:"#CC2B1D", cond_neg:"#C2185B", cond_pos:"#4D6E00",
...
THEMES.kontrastdunkel = {
  ...
  blue:"#5AB7FF", pos:"#3FD06A", neg:"#FF1493", gold:"#FFC83D",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFA53D", cond_gold:"#FFD23D", cond_pos:"#3FD06A",
...
THEMES.mitternacht = {
  ...
  blue:"#6CB4FF", pos:"#4FD08A", neg:"#FF1493", gold:"#FFC861",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFA552", cond_gold:"#FFD263", cond_pos:"#4FD08A",
...
THEMES.modernslate = {
  ...
  blue:"#5B9DF9", pos:"#A3E635", neg:"#FF1493", gold:"#FBBF24",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FBBF24", cond_gold:"#FCD34D", cond_pos:"#A3E635",
  name:"Modern Slate",
};
...
THEMES.deepocean = {
  ...
  blue:"#65E3FD", pos:"#BFFF00", neg:"#FF1493", gold:"#FFC861",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFB54A", cond_gold:"#FFD263", cond_pos:"#BFFF00",
  name:"Deep Ocean",
};
...
THEMES.weltraumtaschengeld = {
  ...
  blue:"#2EE6D6", pos:"#2EE6D6", neg:"#FF1493", gold:"#FFD166",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#FFB84A", cond_gold:"#FFD166", cond_pos:"#2EE6D6",
...
THEMES.magazin = {
  ...
  pos:"#A3C585", neg:"#FF1493", gold:"#D9B45B",
  ...
  cond_neg:"#FF1493", neg_aktuell:"#FF1493", cond_warn:"#D9964A", cond_gold:"#D9B45B", cond_pos:"#A3C585",
